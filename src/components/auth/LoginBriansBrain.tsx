...
/**
 * Brian's Brain — standard implementation.
 * 3 states: off(0), firing(1), dying(2).
 * Off cell with exactly 2 firing neighbors becomes firing.
 * Firing becomes dying. Dying becomes off.
 */
      ...
      if (state === 1) {
        ...
        for (let dy = -1; dy <= 1; dy++) {
          for (let dx = -1; dx <= 1; dx++) {
            ...
            if (grid[ny * cols + nx] === 1) firingNeighbors++;
          }
        }
        next[idx] = firingNeighbors === 2 ? 1 : 0;
      }
    }
  }
...
export function LoginBriansBrain() {
