      ...
      <div className="relative z-10 mx-4 w-full max-w-md animate-modal-enter rounded-(--radius-card) bg-background p-(--spacing-card) shadow-(--shadow-elevated)">
          ...
          <div className="flex flex-col gap-4" data-testid="step-spread-or-period">
            ...
            >
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-primary/10">
                <Icon name="view_day" size={22} color="var(--color-primary)" />
              </div>
        ...
        {step === 'pick_period' && (
          <div className="flex flex-col gap-4" data-testid="step-pick-period">
            ...
            {showSpreadOption && (
              <button
                type="button"
                className="mt-1 flex items-center gap-1.5 self-start text-sm text-muted-foreground hover:text-foreground"
        ...
        {step === 'schedule_precision' && (
          <div className="flex flex-col gap-4" data-testid="step-schedule-precision">
            ...
            >
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-primary/10">
                <Icon name="wb_twilight" size={22} color="var(--color-primary)" />
              </div>
              <div className="flex flex-col gap-0.5">
                <span className="text-sm font-semibold text-foreground">
                  {getTimeOfDayLabel()}
