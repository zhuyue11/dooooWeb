    ...
    <div className="relative flex min-h-screen items-center justify-center bg-background overflow-hidden">
      ...
      <div className="relative z-10 flex w-[420px] flex-col gap-8 rounded-(--radius-card) bg-(--el-auth-card-bg) p-(--spacing-card) shadow-(--shadow-elevated)">
        ...
        <div className="flex flex-col gap-3">
          {/* Google */}
          <button className="flex h-12 items-center justify-center gap-2.5 rounded-(--radius-card) border border-(--el-auth-google-border) bg-(--el-auth-google-bg) text-[15px] font-medium text-(--el-auth-google-text) transition-opacity hover:opacity-80 ">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-[13px] text-(--el-auth-divider-text)">or</span>
            <div className="h-px flex-1 bg-(--el-auth-divider)" />
          </div>
